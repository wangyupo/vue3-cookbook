<template>
  ...
  <div class="flex justify-between">
    <div>
      <teleport to="#topSlot">
        <div
          class="absolute top-0 right-0 bottom-0 left-0 z-10 bg-green-100 flex items-center justify-center flex-col"
          v-if="visibleFull"
        >
          <p>我通过 teleport 挂载到了 Vue app 之外的其他位置， 可打开 public 文件夹下的 index.html 查看以下元素：</p>
          <p>&lt;div id="topSlot"&gt;&lt;/div&gt;</p>
...
const links = [
  {
    ...
    link: "https://cn.vuejs.org/guide/built-ins/teleport.html#teleport",
  },
  {
    label: "vue3 中的 teleport 有哪些属性？",
    link: "https://cn.vuejs.org/api/built-in-components.html#teleport",
  },
  {

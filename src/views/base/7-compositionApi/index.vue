...
const links = [
  {
    label: "什么是组合式 API？",
    link: "https://v3.cn.vuejs.org/guide/composition-api-introduction.html#什么是组合式 API？",
  },
  {
    label: "vue生命周期图示：",
    link: "https://v3.cn.vuejs.org/guide/instance.html#生命周期图示",
  },

  {
    label: "在 <script setup> 中使用组合式生命周期：",
    link: "https://v3.cn.vuejs.org/api/composition-api.html#生命周期钩子",
  },
  {
    label: "所有的组合式生命周期钩子：",
    link: "https://v3.cn.vuejs.org/guide/composition-api-lifecycle-hooks.html",
  },
  {

...
const links = [
  ...
  {
    label: "useRouter 是什么？",
    link: "https://router.vuejs.org/zh/api/#userouter",
  },
  {
    label: "Router 对象都有哪些方法？",
    link: "https://router.vuejs.org/zh/api/#router-方法",
  },
  {
    label: "useRoute 是什么？",
    link: "https://router.vuejs.org/zh/api/#useroute",
  },
  {
    label: "Route 对象都有哪些属性？",
    link: "https://router.vuejs.org/zh/api/#routelocationnormalized",
  },
  {
